...
const config = {
  ...
  MANIFEST_PATH: process.env.MANIFEST_PATH || path.join(ROOT_DIR, 'public', 'cms-manifest.json'),
  ...
  DEFAULT_STAFF_EMAIL: (process.env.DEFAULT_STAFF_EMAIL || 'staff@talabahub.uz').toLowerCase(),
  DEFAULT_STAFF_PASSWORD: process.env.DEFAULT_STAFF_PASSWORD || DEFAULT_STAFF_PASSWORD,
  DEFAULT_EDITOR_EMAIL: (process.env.DEFAULT_EDITOR_EMAIL || 'admin@talabahub.uz').toLowerCase(),
  ...
  ALLOWED_SETTINGS_KEYS: new Set([
    // TalabaHub (super-app) sozlamalari
    'brand_name', 'brand_tagline', 'hero_title', 'hero_intro',
    'contact_phone', 'contact_email', 'contact_telegram', 'advertise_note',
    // Eski profillar (university/castle) bilan moslik uchun saqlanadi
