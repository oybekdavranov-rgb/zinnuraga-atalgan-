...
const PUBLIC_FEEDS = {
  ...
  residences: ['residences', 'featured DESC, sort ASC, id ASC'],
  castlePages: ['castle_pages', 'sort ASC, id ASC'],
  // TalabaHub xizmatlari — pullik (featured) e'lonlar tepada
  roommates: ['roommates', 'sort ASC, id DESC'],
  jobs: ['jobs', 'featured DESC, sort ASC, id DESC'],
  market: ['market', 'featured DESC, sort ASC, id DESC'],
  partners: ['partners', 'featured DESC, sort ASC, id ASC'],
};
