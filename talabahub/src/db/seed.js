...
async function seedContent() {
  ...
  // ---- TalabaHub xizmatlari (namuna ma'lumot) ----
  await seedTable('roommates', ['title', 'gender', 'faculty', 'course', 'area', 'budget', 'about', 'contact', 'image', 'sort'], [
    {
      title: 'Markazdan hamxona izlayapman', gender: 'Erkak', faculty: 'Axborot texnologiyalari', course: '2-kurs',
      area: 'Qo‘qon — markaz', budget: 'Oyiga 700–900 ming so‘m', image: 'shaharcha/img/dost.jpg',
      about: 'Tinch, tartibli talabaman. Universitetga yaqin ijaraga birga chiqadigan hamxona qidiryapman. Chekmayman, kechqurunlari o‘qiyman.',
      contact: 'Telegram: @student_ex',
    },
    {
      title: 'Bo‘sh joy bor — qiz talabaga', gender: 'Ayol', faculty: 'Filologiya', course: '3-kurs',
      area: 'Qo‘qon — universitet yaqinida', budget: 'Oyiga 600 ming so‘m', image: 'shaharcha/img/xona.jpg',
      about: 'Ijara kvartirada bitta bo‘sh joy bor. Uy jihozlangan, internet bor. Toza va mas’uliyatli qiz talaba bo‘lsa.',
      contact: 'Tel: +998 90 000 00 00',
    },
    {
      title: 'Ikki kishilik xonaga sherik', gender: 'Erkak', faculty: 'Iqtisodiyot', course: '1-kurs',
      area: 'Qo‘qon — Turkiston ko‘chasi', budget: 'Oyiga 500 ming so‘m', image: 'shaharcha/img/joylar.jpg',
      about: 'Yangi o‘quv yilidan ijaraga chiqmoqchiman. Xarajatlarni bo‘lishadigan, sport bilan shug‘ullanadigan hamxona bo‘lsa yaxshi.',
      contact: 'Telegram: @newstudent',
    },
  ]);

  await seedTable('jobs', ['title', 'company', 'jobtype', 'pay', 'area', 'description', 'contact', 'link', 'featured', 'sort'], [
    {
      title: 'Barista (yarim kunlik)', company: 'City Coffee', jobtype: 'Part-time', pay: 'Soatiga 25 000 so‘m + choychaqa',
      area: 'Qo‘qon — markaz', featured: 1,
      description: 'Talabalar uchun qulay ish grafigi. Tajriba shart emas — o‘rgatamiz. Kuniga 4–6 soat, dars jadvaliga moslab.',
      contact: 'Tel: +998 90 111 22 33', link: '',
    },
    {
      title: 'SMM menejer', company: 'Mahalliy do‘kon', jobtype: 'Masofaviy', pay: 'Oyiga 1,5–2,5 mln so‘m',
      area: 'Masofaviy (Qo‘qon)', featured: 0,
      description: 'Instagram va Telegram sahifalarini yuritish, kontent tayyorlash. Ijodkor va mas’uliyatli talabalar uchun.',
      contact: 'Telegram: @localshop_hr', link: '',
    },
    {
      title: 'Repетitor — matematika', company: 'O‘quv markazi', jobtype: 'Part-time', pay: 'Darsiga 40 000 so‘m',
      area: 'Qo‘qon — Istiqlol ko‘chasi', featured: 0,
      description: 'Maktab o‘quvchilariga matematika o‘rgatadigan yuqori kurs talabalari kerak. Kechki vaqtlar.',
      contact: 'Tel: +998 91 222 33 44', link: '',
    },
    {
      title: 'Ombor yordamchisi (shanba-yakshanba)', company: 'Logistika kompaniyasi', jobtype: 'Dam olish kunlari', pay: 'Kuniga 150 000 so‘m',
      area: 'Qo‘qon — sanoat zonasi', featured: 0,
      description: 'Faqat dam olish kunlari ishlash imkoniyati. Jismonan sog‘lom talabalar uchun.',
      contact: 'Tel: +998 93 333 44 55', link: '',
    },
  ]);

  await seedTable('market', ['title', 'category', 'price', 'condition', 'area', 'description', 'contact', 'image', 'featured', 'sort'], [
    {
      title: 'Yozuv stoli + stul', category: 'Mebel', price: '350 000 so‘m', condition: 'Ishlatilgan (a’lo)',
      area: 'Qo‘qon — markaz', featured: 1, image: 'shaharcha/img/jihoz.jpg',
      description: 'O‘qish uchun qulay stol va stul. Bitiruvchi talaba sotmoqda, holati juda yaxshi. Yetkazib berish kelishiladi.',
      contact: 'Telegram: @seller_ex',
    },
    {
      title: 'Noutbuk (i5, 8GB)', category: 'Texnika', price: '3 200 000 so‘m', condition: 'Ishlatilgan',
      area: 'Qo‘qon — universitet yaqinida', featured: 0, image: '',
      description: 'Dasturlash va o‘qish uchun yetarli. Zaryadi 4 soat, hujjatlari bor. Kelishuv mumkin.',
      contact: 'Tel: +998 90 555 66 77',
    },
    {
      title: 'Mini muzlatgich', category: 'Maishiy texnika', price: '600 000 so‘m', condition: 'Ishlatilgan (yaxshi)',
      area: 'Qo‘qon — Turkiston ko‘chasi', featured: 0, image: '',
      description: 'Yotoqxona uchun juda qulay, kam joy egallaydi. Ishlaydi, muammosiz.',
      contact: 'Telegram: @fridge_sale',
    },
    {
      title: 'Darsliklar to‘plami (1-kurs)', category: 'Kitob', price: '150 000 so‘m', condition: 'Ishlatilgan',
      area: 'Qo‘qon — markaz', featured: 0, image: '',
      description: 'Iqtisodiyot yo‘nalishi 1-kurs darsliklari to‘plami. Yozuvsiz, toza saqlangan.',
      contact: 'Tel: +998 94 777 88 99',
    },
  ]);

  await seedTable('partners', ['name', 'category', 'discount', 'area', 'description', 'image', 'link', 'featured', 'sort'], [
    {
      name: 'FitZone sport zali', category: 'Sport', discount: '-30% talabalarga', area: 'Qo‘qon — markaz',
      featured: 1, image: 'shaharcha/img/hayot.jpg', link: '',
      description: 'Talaba guvohnomasini ko‘rsating — oylik abonement 30% arzon. Zamonaviy jihozlar, murabbiy yordami.',
    },
    {
      name: 'BookCafe', category: 'Kafe', discount: '-15% barcha menyuga', area: 'Qo‘qon — universitet yaqinida',
      featured: 1, image: 'shaharcha/img/aloqa.jpg', link: '',
      description: 'O‘qish uchun tinch muhit, tez internet va talabalarga chegirma. Kofe + shirinlik kombinatsiyalari.',
    },
    {
      name: 'IELTS Study Center', category: 'Ta’lim', discount: 'Birinchi oy -50%', area: 'Qo‘qon — Istiqlol ko‘chasi',
      featured: 0, image: '', link: '',
      description: 'Ingliz tili va IELTS kurslari. TalabaHub orqali kelganlarga birinchi oy yarim narxda.',
    },
    {
      name: 'PrintPro bosmaxona', category: 'Xizmat', discount: 'A4 chop -20%', area: 'Qo‘qon — markaz',
      featured: 0, image: '', link: '',
      description: 'Diplom, referat, taqdimot chop etish va muqovalash. Talabalarga doimiy chegirma.',
    },
  ]);
...
module.exports = { bootstrapUsers, seedContent, cleanupSessions };
